...
export default function LandingPage({ onGetStarted, onAuthSuccess }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      ...
      {/* How It Works Section - ÖZGÜN LAYOUT */}
      <section className="py-32 bg-gradient-to-br from-white via-purple-50 to-pink-50 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
        
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center space-x-2 bg-purple-100 px-4 py-2 rounded-full text-purple-600 font-bold mb-6">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              AI destekli platformumuz ile saniyeler içinde yüksek kaliteli video reklamlar oluşturun
            </p>
          </div>
          ...
          <div className="relative">
            {/* Connecting Line */}
            <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-purple-200 via-pink-200 to-blue-200 transform -translate-y-1/2"></div>
            
            <div className="grid md:grid-cols-3 gap-12 relative z-10">
              {/* Step 1 */}
              <div className="text-center group">
                <div className="relative inline-block mb-8">
                  <div className="absolute -inset-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full blur-2xl opacity-20 group-hover:opacity-40 transition duration-500"></div>
                  <div className="relative w-32 h-32 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-300">
                    <Upload className="w-16 h-16 text-white" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg font-black text-purple-600 text-xl">
                    1
                  </div>
                </div>
                <h3 className="text-2xl font-black text-gray-900 mb-4">İçeriğinizi Yükleyin</h3>
                <p className="text-gray-600 text-lg leading-relaxed">
                  Ürün görseli, logo ve markanızı yansıtan içerikleri yükleyin. Desteklenen formatlar: JPG, PNG, MP4
                </p>
              </div>
              ...
              <div className="text-center group">
                <div className="relative inline-block mb-8">
                  <div className="absolute -inset-4 bg-gradient-to-r from-pink-600 to-purple-600 rounded-full blur-2xl opacity-20 group-hover:opacity-40 transition duration-500"></div>
                  <div className="relative w-32 h-32 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-300">
                    <Sparkles className="w-16 h-16 text-white" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg font-black text-pink-600 text-xl">
                    2
                  </div>
                </div>
                <h3 className="text-2xl font-black text-gray-900 mb-4">AI Otomatik Oluşturur</h3>
                <p className="text-gray-600 text-lg leading-relaxed">
                  Yapay zekamız markanıza özel, profesyonel kalitede video reklamlar oluşturur. Format, diyalog, müzik dahil!
                </p>
              </div>
              ...
              <div className="text-center group">
                <div className="relative inline-block mb-8">
                  <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full blur-2xl opacity-20 group-hover:opacity-40 transition duration-500"></div>
                  <div className="relative w-32 h-32 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-300">
                    <Download className="w-16 h-16 text-white" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg font-black text-blue-600 text-xl">
                    3
                  </div>
                </div>
                <h3 className="text-2xl font-black text-gray-900 mb-4">İndirin & Paylaşın</h3>
                <p className="text-gray-600 text-lg leading-relaxed">
                  HD kalitede videolarınızı indirin ve tüm sosyal medya platformlarında anında paylaşın
                </p>
              </div>
            </div>
            ...
            <div className="text-center mt-16">
              ...
              >
                <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-2xl blur-lg opacity-50 group-hover:opacity-100 transition duration-500"></div>
                <div className="relative bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 hover:from-purple-600 hover:via-pink-600 hover:to-blue-600 text-white px-12 py-5 rounded-2xl font-black text-xl inline-flex items-center space-x-3 shadow-2xl transform hover:scale-110 transition-all duration-300">
                  <span>Hemen Deneyin - Ücretsiz</span>
                  <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
                </div>
              </button>
              <p className="text-gray-500 mt-4 text-sm">Kredi kartı gerekmez • 3 ücretsiz video • 30 saniyede kurulum</p>
            </div>
          </div>
        </div>
      </section>
