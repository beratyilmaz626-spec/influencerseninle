            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                <button
                  type="button"
                  onClick={() => {
                    alert('Google ile giriş için Supabase Dashboard\'da Google OAuth etkinleştirmeniz gerekiyor.');
                  }}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors text-white font-medium"
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    alert('Apple ile giriş için Supabase Dashboard\'da Apple OAuth etkinleştirmeniz gerekiyor.');
                  }}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors text-white font-medium"
                >
